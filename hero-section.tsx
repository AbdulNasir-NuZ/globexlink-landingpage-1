...
export default function HeroSection() {
  ...
  const slides = [
    {
      image: "/cargo-ship-global-trade-logistics-teal-tone.png",
      alt: "Container cargo ship at sea representing global trade logistics",
    },
    {
      image: "/african-farm-cooperative-traceability-aerial.png",
      alt: "Aerial view of African farm cooperative for traceability and sourcing",
    },
    {
      image: "/warehouse-inspection-quality-control-compliance.png",
      alt: "Warehouse inspection and quality control for compliance",
    },
  ]

  const navItems = [
    { name: "ESG", href: "#testimonials" },
  ...
  return (
    <div id="hero" className="relative h-screen w-full overflow-hidden bg-black">
      ...
      <nav className="relative z-20 flex items-center justify-between p-6 md:p-8">
        {/* Logo/Brand */}
        <div className="text-white font-bold text-xl tracking-wider">GLOBXLINK</div>
      ...
      <div className="relative z-10 flex h-full items-center justify-center px-6">
        <div className="text-center text-white max-w-4xl">
          ...
          <p className="text-xl md:text-2xl font-light tracking-wide mb-8 text-gray-200">
            Pan‑Continental B2B Trade • Africa ↔ Turkey ↔ Asia
          </p>
